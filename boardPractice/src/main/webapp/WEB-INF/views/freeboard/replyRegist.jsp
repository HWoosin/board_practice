            ...
            <div class="row">
                <div class="col-xs-12 content-wrap">
                    <div class="titlebox">
                     ...
                     <form action="${pageContext.request.contextPath}/freeboard/replyBoard" method="post" name="registForm" onsubmit="return false" enctype="multipart/form-data">   
                                ...
                                <div class="reply-content">
                                    <div class="reply-group">
                                        <div class="filebox pull-left">
                                            ...
                                            <input type="file" onchange="addFile(this);" name="file" id="file" multiple>
