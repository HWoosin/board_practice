...
public final class freeDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <small class='left'>` + (replyList[i].updateDate != null ? parseTime(replyList[i].updateDate) + '(수정 됨)' : parseTime(replyList[i].replyDate)) + `</small>\r\n");
      ...
      out.write("                2. fetch함수를 이용해서 DELETE 방식으로 reply/{rno}요청\r\n");
      out.write("                3. 서버에서는 요청을 받아서 비밀번호를 확인하고, 비밀번호가 맞으면 삭제를 진행하면 된다.\r\n");
      out.write("                4. 만약 비밀번호가 틀렸다면, 문자열을 반환해서 '비밀번호가 틀렸습니다.' 경고창 출력\r\n");
      out.write("                삭제 완료되면 모달닫고 목록 요청 다시 보내기. (reset의 여부 잘 판단)\r\n");
      out.write("                */\r\n");
      out.write("            const rno = document.getElementById('modalRno').value;\r\n");
      out.write("            const replyPw = document.getElementById('modalPw').value;\r\n");
      ...
      out.write("\r\n");
      out.write("                let time;\r\n");
      out.write("                if(gap < 60 * 60 * 24 * 1000){//하루안돼?\r\n");
      out.write("                    if(gap < 60*60*1000){//한시간 안돼?\r\n");
      out.write("                        time = '방금 전';\r\n");
      out.write("                    }\r\n");
      out.write("                    else{\r\n");
